...
public class AccountMicroserviceApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        userDao.save(new User("CCRNTN77E31E986J", "Antonio Cecere", encryptedPwd, "user"));
        ...
        accountDao.save(new Account("cn4563df3", "CCRNTN77E31E986J", 3000.00));
        accountDao.save(new Account("cn7256su9", "CCRNTN77E31E986J", 4000.00));
